...
const AppSidebar: React.FC = () => {
  ...
  const basePath =
    ...
    role === "D" ? `/doctor/${doctorType === "E" ? "examination" : doctorType === "S" ? "service" : ""}` :
    "/admin";
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "Phòng khám", path: `${basePath}/outpatient-clinics`, pro: false },
      ],
    ...
    },
    {
      ...
      icon: <InpatientIcon />,
      subItems: [
        { name: "Phòng bệnh", path: `${basePath}/inpatients-rooms`, pro: false },
        { name: "Bệnh nhân nội trú", path: `${basePath}/inpatients`, pro: false },
      ],
      roles: ["A", "RECEPTIONIST"],
    },
    {
