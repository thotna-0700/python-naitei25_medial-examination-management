    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center justify-between pb-3 mb-3 border-b border-gray-100 dark:border-gray-700">
          <h5 className="text-lg font-semibold text-gray-800 dark:text-gray-200">{t("notifications.title")}</h5>
          <button
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 block  text-theme-sm text-gray-500 dark:text-gray-400 space-x-1">
                  ...
                  <span> {t("notifications.requestsPermission")}</span>
                  <span className="font-medium text-gray-800 dark:text-white/90">Project - Nganter App</span>
                </span>

                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                  <span>{t("notifications.project")}</span>
                  <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
                  <span>5 {t("notifications.minAgo")}</span>
                </span>
              </span>
            </DropdownItem>
          </li>
            ...
            >
              ...
              <span className="block">
                ...
                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                  <span>{t("notifications.project")}</span>
                  <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
                  <span>8 {t("notifications.minAgo")}</span>
                </span>
              </span>
            </DropdownItem>
          </li>
            ...
            >
              ...
              <span className="block">
                ...
                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                  <span>{t("notifications.project")}</span>
                  <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
                  <span>15 {t("notifications.minAgo")}</span>
                </span>
              </span>
            </DropdownItem>
          </li>
            ...
            >
              ...
              <span className="block">
                ...
                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                  <span>{t("notifications.project")}</span>
                  <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
                  <span>1 {t("notifications.hrAgo")}</span>
                </span>
              </span>
            </DropdownItem>
          </li>
