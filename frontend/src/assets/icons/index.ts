...
import Calender2Icon  from "./calendar2.svg?react";
...
import DoctorIcon  from "./doctor.svg?react";
import PatientIcon  from "./patient.svg?react";
import MedicalRecordIcon  from "./medical-record.svg?react";
import DepartmentIcon  from "./team.svg?react";
import BedIcon  from "./bed.svg?react";
import MedicineIcon  from "./medicine.svg?react";
import InpatientIcon  from "./inpatient.svg?react";
import AdminIcon  from "./admin.svg?react";
import ClinicIcon  from "./clinics.svg?react";
import ActiveIcon from './active.svg?react';
import WarningIcon  from "./warning.svg?react";
import FullIcon  from "./full.svg?react";
