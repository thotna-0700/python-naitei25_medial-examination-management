...
const MedicalRecordDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    if (
      ...
      appointment.service_orders.length > 0
    ) {
      const fetchServices = async () => {
        try {
          console.log("Service Orders:", appointment.service_orders);
          const promises = appointment.service_orders.map((order) =>
            serviceService.getServiceById(order.service_id)
          );
      ...
      <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
              ...
              <p className="text-red-900 font-semibold">
                ...
                {record.diastolic_blood_pressure} mmHg
              </p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-semibold text-gray-900">
              {t("medicalRecord.servicesAndResults")}
            </h2>
          </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 text-sm">
                      <div>
                        <p className="text-gray-600 mb-1">
                          {t("medicalRecord.price")}
                        </p>
                        <p className="font-medium text-gray-900">
                          {detail.price || t("medicalRecord.noData")}
                        </p>
                      </div>
                      <div>
                        <p className="text-gray-600 mb-1">
                          {t("medicalRecord.orderTime")}
                        </p>
                        <p className="font-medium text-gray-900">
                          {order.order_time
                      ...
                      <div>
                        <p className="text-gray-600 mb-1">
                          {t("medicalRecord.resultTime")}
                        </p>
                        <p className="font-medium text-gray-900">
                          {order.result_time
                            ? formatDate(order.result_time)
                            : t("medicalRecord.noData")}
                        </p>
                      </div>
                    </div>
