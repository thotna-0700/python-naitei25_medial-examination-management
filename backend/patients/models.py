...
class Patient(BaseModel):
    ...
    insurance_number = models.CharField(max_length=PATIENT_LENGTH["INSURANCE"], unique=True)
    ...
    blood_type = models.CharField(max_length=PATIENT_LENGTH["BLOOD_TYPE"], blank=True, null=True)
